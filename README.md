...
<table style="border-collapse: collapse; width: 100%; border: 0px solid #2b5c8f;">
  ...
  <tbody>
    <tr style="background-color: rgb(247, 246, 246);">
      ...
      <td style="border: 0px solid #cbd5e1; padding: 4px 10px;"><em>Ladybug</em></td>
      <td style="border: 0px solid #cbd5e1; padding: 4px 10px;">Value of <em>sunlight hours</em> at each point</td>
    </tr>
  </tbody>
</table>
